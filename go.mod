module github.com/livekit/signal-proxy
...
require (
	...
	github.com/livekit/server-sdk-go/v2 v2.1.1-0.20240415173214-5d42adc6aa0b
...
require (
	...
	github.com/livekit/psrpc v0.5.3-0.20240315045730-ba2e5b9923b5 // indirect
